...
/**
 * Bot码工具类 https://docs.cqp.im/manual/cqcode/
 */
public class BotCode {
  ...
  /**
   * emoji表情 id表 https://cqp.cc/t/15827
   *
  ...
  public static String location(double lat, double lon, String title, String content) {
    return "[CQ:location,lat=" + lat + ",lon=" + lon + ",title=" + escape(title) + ",content="
      + escape(content) + "]";
  }
  ...
  public static String sign(String location, String title, String image) {
    return "[CQ:sign,location=" + escape(location) + ",title=" + escape(title) + ",image=" + escape(
      image) + "]";
  }
   ...
   */
  public static String customMusic(String url, String audio, String title, String content,
    String image) {
    return "[CQ:music,type=custom,url=" + escape(url) + ",audio=" + escape(audio) + ",title="
      + escape(title) + ",content=" + escape(content) + ",image=" + escape(image) + "]";
  }
  ...
  public static String share(String url, String title, String content, String image) {
    return "[CQ:share,url=" + escape(url) + ",title=" + escape(title) + ",content=" + escape(
      content) + ",image=" + escape(image) + "]";
  }
